...
import logo from "../../assets/nabvar/logo_future_tech.png";
  ...
  return (
    <nav className="bg-black sticky top-0 shadow-md z-50">
      <div className="container mx-auto flex items-center justify-between px-4 ">
        <img src={logoPlaceholder} alt="logo" className="w-24 h-24 py-2 " />
        ...
        <div className="hidden lg:flex space-x-12 relative items-center">
          ...
          <Link to="/Hardware" className="text-white hover:text-gray-300">
            HARDWARE
          </Link>
          <Link to="/Managed" className="text-white hover:text-gray-300">
            MANAGED SERVICES
          </Link>
          <Link to="/Marketing" className="text-white hover:text-gray-300">
            MARKETING
          </Link>
          <Link to="/Development" className="text-white hover:text-gray-300">
            DEVELOPMENT
          </Link>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-black border-t border-gray-800">
          <div className="container mx-auto px-4 py-2">
            <Link to="/" className="block py-2 text-white hover:text-gray-300">
              HOME
            </Link>
            <Link
              to="/Hardware"
